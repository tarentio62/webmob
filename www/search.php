...
<meta name="description"
	content="Base de donn&eacute;e sur les Bandes dessin&eacute;es" />
...
<script src="jss/librairie.js" type="text/javascript"></script>
</head>

<body>
	<div class="wrapper">
		<a href="index.html" id="header"> <img src="img/logo-72.png"
			class="logo" alt="logo myBd" title="Moteur de recherche de Bd" />
			<div class="titre">
				<h1>MyBd.fr</h1>
		...
		<div id="content">
			...
			<form action="search.php" method="GET">
				<fieldset>
					...
					<div class="column">
						<div>
							<label for="auteur">Auteur</label> <input id="auteur"
								name="auteur">
						</div>
						<div>
					...
					<div class="column">
						<div>
							<label for="titre">Titre</label> <input id="titre" name="titre">
						</div>
						<div>
							<label for="annee">Ann&eacute;e</label> <input id="annee"
								type="range" name="annee">
						</div>
					</div>
					<div class="column">
						<div>
						...
						<div>
							<label for="dispo">Disponibilit&eacute;</label> <input id="dispo"
								name="dispo">
						</div>
					</div>
					<br class="clear" />
					<div class="footer">
						<div>
							<input type="button" id="submit" onclick="set()" name="submit"
								value="Rechercher">
						</div>
					</div>
				</fieldset>
